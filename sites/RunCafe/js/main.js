...
function initSliders() {
	...
	if (document.querySelector('.slider-tabs-schedule-main')) {
		document.querySelectorAll('.slider-tabs-schedule-main').forEach((slider) => {
			const scrollbar = slider.closest("[slider-body]").querySelector('.slider-tabs-schedule-main__scrollbar');
			new Swiper(slider, {
				observer: true,
				observeParents: true,
				slidesPerView: "auto",
