...
function initSliders() {
	...
	if (document.querySelector('.slider-key')) {
		new Swiper('.slider-key', {
			...
			speed: 800,
			navigation: {
				nextEl: ".slider-key__next",
				prevEl: ".slider-key__prev",
			},
		});
	}
	...
	if (document.querySelector('.slider-news-detail')) {
		new Swiper('.slider-news-detail', {
  		observer: true,
			observeParents: true,
			slidesPerView: 4,
			spaceBetween: 30,
			...
			navigation: {
				nextEl: ".slider-news-detail__next",
				prevEl: ".slider-news-detail__prev",
			},
		});
	}
}
