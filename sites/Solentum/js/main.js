...
function MouseParallax(parallax) {
	let content = parallax.querySelector('.parallax__container');
	let imageFirst = content.querySelector('[data-image-one]');
	let imageSecond = content.querySelector('[data-image-two]');
	let imageThird = content.querySelector('[data-image-three]');
	...
	function setMouseParallaxStyle() {
		...
		//Передаём стили
		let forImageFirst = Number(imageFirst.dataset.imageOne);
		imageFirst.style.cssText = `transform: translate(${positionX / forImageFirst}%,${positionY / forImageFirst}%);`;

		if(imageSecond) {
			let forImageSecond = Number(imageSecond.dataset.imageTwo);
			imageSecond.style.cssText = `transform: translate(${positionX / forImageSecond}%,${positionY / forImageSecond}%);`;
		}

		if(imageThird) {
			let forImageThird = Number(imageThird.dataset.imageThree);
			imageThird.style.cssText = `transform: translate(${positionX / forImageThird}%,${positionY / forImageThird}%);`;
		}
