...
if(document.querySelector('#radiobuttons')) {
    ...
    radioButtonsBodies.forEach(function (radioButtonsBody) {
        radioButtonsBody.querySelectorAll('.radio__button').forEach(function (radio) {
        ...
        radioButtonsBody.addEventListener('click', (e) => {
            ...
            if(e.target.closest('.radio__button')) {
                radioButtonsBody.querySelectorAll('.radio__button').forEach(function (radio) {
                    radio.classList.remove('active');
                });
                e.target.closest('.radio__button').classList.add('active'); 
            } 
